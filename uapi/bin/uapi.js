...
Main.handleEitherType = function(either,array) {
	if(typeof(either) == "string") {
		...
		while(_g < arr.length) {
			var el = arr[_g];
			++_g;
			var pos = Object.prototype.hasOwnProperty.call(el,"index") && el.index == null ? el.index : -1;
			array.splice(pos,0,el.content);
		}
	}
};
