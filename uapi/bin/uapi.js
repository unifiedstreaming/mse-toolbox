...
Main.writePlayer = function(parent,uri,player_version_string,player_config,inject_head,inject_body) {
	...
	if(null != inject_head) {
		...
		case 0:
			...
			break;
		case 1:
			var cfgArray = inject_head[2];
			var _g3 = 0;
			while(_g3 < cfgArray.length) {
				var el = cfgArray[_g3];
				++_g3;
				head.splice(el.index == null ? -1 : el.index,0,el.content);
			}
			break;
		}
	}
	if(null != inject_body) {
		...
		case 0:
			...
			break;
		case 1:
			var cfgArray1 = inject_body[2];
			var _g4 = 0;
			while(_g4 < cfgArray1.length) {
				var el1 = cfgArray1[_g4];
				++_g4;
				body.splice(el1.index == null ? -1 : el1.index,0,el1.content);
			}
			break;
		}
	}
