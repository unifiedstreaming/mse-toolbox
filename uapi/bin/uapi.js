	...
	var retval1 = new Promise(function(resolve1,reject) {
		...
		iframe1.hook = function(contentWindow) {
			...
			contentWindow.onunhandledrejection = function(e1) {
				...
				handleError(retval4,contentWindow);
			};
