                ...
                player.configure({
                    drm: {
                        servers: {
                            ...
                            'com.microsoft.playready'   : Argan.getDefault("drm_server_playready","com.widevine.alpha", 'https://playready.directtaps.net/pr/svc/rightsmanager.asmx?PlayRight=1&UseSimpleNonPersistentLicense=1&PlayEnablers=786627D8-C2A6-44BE-8F88-08AE255B01A7')
                        }
                    }
                });
