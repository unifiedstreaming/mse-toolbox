...
Main.writePlayer = function(parent,uri,player_version_string,player_config,inject_head,inject_body) {
	...
	var html3 = player.toUpperCase();
	var html4 = Main.generatePosterImage(uri,html3);
	var _;
	var _1;
	if(Argan.args != null) {
	...
	var html5 = head.join("\n");
	var html6 = body.join("\n");
	var html7 = error != null ? "<pre>uapi error:\n" + error + "</pre>" : haxe_Resource.getString("controls_template");
	var html8 = html.execute({ uri : html1, loading : html2, title : player, title_version : version, title_href : last_src, poster : html4, attr_autoplay : _, attr_muted : _2, attr_controls : _4, attr_playsinline : _6, head : html5, body : html6, controls : html7});
