...
var Main = function() {
	...
	var _g3 = 0;
	while(_g3 < frames.length) {
		var f = frames[_g3];
		++_g3;
		uapi_Hooks.hookMethods(Reflect.field(f,"XMLHttpRequest"),["prototype.open","prototype.send"]).pipe(function(method,args) {
			var xmlhttpRequest = this;
			switch(method) {
			case "prototype.open":
				var url = new haxe_io_Path(args[1].split("?")[0]);
				...
				xmlhttpRequest.addEventListener("load",function() {
					if(xmlhttpRequest.responseType == "arraybuffer") {
						...
						if(moov != null) {
							...
							window.console.log(initSegments.h[url.__id__].timescale);
						}
	...
	while(_g < methods.length) {
		...
		uapi_Hooks.hookMethod(object,m[0]).pipe((function(m1) {
			return function($arguments) {
				pipe.apply(this,[m1[0],$arguments]);
			};
		})(m));
	}
	return retval;
...
uapi_Hooks.HashPipe = function() {
	var pipe = null;
	var retval_pipe = function(func) {
		pipe = func;
	};
...
ui_UIManager.prototype = {
	...
	,createWindow: function(windowType) {
		...
		topbar.innerText = null != title ? title : "USP MSE Debugger: " + "teunSuperluek.local" + ", " + "Git short SHA1:5b001f0";
