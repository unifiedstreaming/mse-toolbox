...
Main.writePlayer = function(parent,uri,player_version_string,player_config,inject_head,inject_body) {
	...
	var html6 = html.execute({ uri : html1, loading : html2, title : player, title_version : version, title_href : last_src, attr_autoplay : _, attr_muted : _2, attr_controls : _4, attr_playsinline : _6, head : html3, body : html4, controls : html5});
