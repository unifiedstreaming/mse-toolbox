...
Main.prototype = {
	...
	,hookWindow: function($window) {
		...
		uapi_Hooks.hookMethod($window,"URL.createObjectURL").pipe(function(args) {
			if(args.length > 0) {
				if(args[0].toString() == "[object MediaSource]") {
					var source = args[0];
					uapi_Hooks.hookMethod(source,"addSourceBuffer").pipe(function(args1,method_original) {
		...
		uapi_Hooks.hookMethods(Reflect.field($window,"XMLHttpRequest"),["prototype.open","prototype.send"]).pipe(function(method,args3,test) {
			...
			case "prototype.open":
				...
				xmlhttpRequest.addEventListener("load",function() {
					if(xmlhttpRequest.responseType == "arraybuffer") {
						...
						console.log("src/Main.hx:121:",boxes);
						...
						if(moov != null) {
							...
							window.console.log("mdhd.duration: " + Std.string(initSegments.h[url1.__id__].duration) + " mdhd.timescale: " + initSegments.h[url1.__id__].timescale);
						}
						...
						if(url1.file.indexOf("video") > -1) {
							...
							var value1 = "" + segment.duration;
							if(__map_reserved["label"] != null) {
								_g.setReserved("label",value1);
							} else {
								_g.h["label"] = value1;
							}
							...
							var value2 = "" + segment.start * 10 + "px";
							if(__map_reserved["left"] != null) {
								_g1.setReserved("left",value2);
							} else {
								_g1.h["left"] = value2;
							}
							var value3 = "" + (segment.duration * 10 - 4.5) + "px";
							if(__map_reserved["width"] != null) {
								_g1.setReserved("width",value3);
							} else {
								_g1.h["width"] = value3;
							}
							uapi_JsUtils.setCSSStyles(el1,_g1);
						}
						console.log("src/Main.hx:179:",segment);
					}
				});
				break;
			case "prototype.send":
...
Mp4lib.Version = function() {
	return "stable-12-g7a16737, 2019-04-17 15:24:35";
};
...
uapi_ui_UIManager.prototype = {
	...
	,createWindow: function(windowType) {
		...
		topbar.innerText = null != title ? title : "USP MSE Debugger: " + "stable-12-g7a16737, 2019-04-17 15:24:35";
...
var ui_Shell = function() {
	...
	tmp2.addTemplate("tab",_g2,"tab_main_button");
	...
	tmp3.addTemplate("right_column_line",_g3);
	var tmp4 = this.mal;
	var _g4 = new haxe_ds_StringMap();
	if(__map_reserved["field"] != null) {
		_g4.setReserved("field","");
	} else {
		_g4.h["field"] = "";
	}
	if(__map_reserved["id"] != null) {
		_g4.setReserved("id","test");
	} else {
		_g4.h["id"] = "test";
	}
	if(__map_reserved["label"] != null) {
		_g4.setReserved("label","blaa");
	} else {
		_g4.h["label"] = "blaa";
	}
	tmp4.addTemplate("checkbox",_g4);
	...
	if(__map_reserved["label"] != null) {
		_g5.setReserved("label","blaap");
	} else {
		_g5.h["label"] = "blaap";
	}
	tmp5.addTemplate("segments_cell",_g5);
